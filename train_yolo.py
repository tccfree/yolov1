...
if __name__=='__main__':
    ...
    #darknet = torch.nn.DataParallel(darknet,device_ids=[0,1])
    ...
    yolo = YOLOv1(darknet)
    yolo.cuda()
    yolo = torch.nn.DataParallel(yolo,device_ids=[0,1])


    # Setup loss and optimizer.
    criterion = Loss(feature_size=yolo.module.feature_size)
