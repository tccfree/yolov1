...
if __name__ == '__main__':
    ...
    out_path = 'result2.png'
    # Path to the yolo weight.
    model_path = 'results/yolo/Oct10_20-15-35/model_best.pth'
    # GPU device on which yolo is loaded.
    gpu_id = 0,1

    # Load model.
    yolo = YOLODetector(model_path, gpu_id=gpu_id, conf_thresh=0.1, prob_thresh=0.1, nms_thresh=0.25)
